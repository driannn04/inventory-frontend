...
export default function MenuPermissions() {
  ...
  const availableMenus = [
    ...
    { key: "pengajuan-saya", name: "Pengajuan Anda", desc: "Melihat riwayat pengajuan barang yang dibuat oleh akun sendiri." },
    { key: "approval", name: "Persetujuan Pengajuan", desc: "Melakukan persetujuan (approval) pengajuan barang (Manager/Asmen/Gudang)." },
