...
export default function ListPengajuan() {
  ...
  const stats = [
    ...
    { key: "pending_asisten_manager", label: "Menunggu Asmen", color: "from-amber-500 to-orange-500", icon: <ShieldCheck size={16} />, count: countByStatus("pending_asisten_manager") },
    { key: "pending_manager", label: "Menunggu Manager", color: "from-blue-600 to-sky-500", icon: <User size={16} />, count: countByStatus("pending_manager") },
    { key: "pending_gudang", label: "Menunggu Gudang", color: "from-indigo-600 to-purple-500", icon: <Package size={16} />, count: countByStatus("pending_gudang") },
    { key: "completed", label: "Selesai", color: "from-emerald-500 to-teal-600", icon: <CheckCircle size={16} />, count: countByStatus("completed") },
    { key: "rejected", label: "Ditolak", color: "from-rose-500 to-pink-600", icon: <XCircle size={16} />, count: countByStatus("rejected") },
  ];
