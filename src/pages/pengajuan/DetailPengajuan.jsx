                        ...
                        ${currentStatus === "completed" ? "text-emerald-500" : currentStatus === "rejected" ? "text-rose-500" : "text-blue-600"}`}>
                            ...
                            <div className="relative z-10 flex flex-wrap items-center justify-between gap-8">
                                <div className="space-y-4">
                                    ...
                                    <h2 className={`text-5xl font-black uppercase tracking-tighter leading-none ${currentStatus === "completed" ? "text-emerald-600 dark:text-emerald-400" :
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-1">
                                        <span className={`text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-lg border ${data[0]?.pengaju_role === 'manager' ? 'bg-amber-50 text-amber-700 border-amber-200' :
                                ...
                                {steps.map((step, i) => (
                                    ...
                                    ${step.rejected ? `bg-gradient-to-br from-rose-500 to-red-600 text-white shadow-rose-500/20 scale-110` :
                                        ...
                                        <div className="flex flex-col">
                                            <p className={`text-[11px] font-black uppercase tracking-[0.15em] ${step.rejected ? "text-rose-600 dark:text-rose-400" :
