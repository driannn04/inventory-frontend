                    ...
                    <div className="h-[300px] w-full min-w-0">
                        <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                            <AreaChart data={trendData} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
                                ...
                                <Area type="monotone" name="Inbound (Masuk)" dataKey="masuk" stroke="#06b6d4" strokeWidth={3} fillOpacity={1} fill="url(#colorTrend)" />
                                <Area type="monotone" name="Outbound (Keluar)" dataKey="keluar" stroke="#3b82f6" strokeWidth={2} strokeDasharray="5 5" fill="none" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
